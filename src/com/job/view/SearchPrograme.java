...
//	            dow, phone});
			...
			if (region.equals("[근무지역]") && typeOccup.equals("[근무형태]") && periodType.equals(periodType2)) {
				System.out.println(pt.get(i)); // 결과가 잘나오는지 출력

				pt2.add((Resume) pt.get(i)); // wk의 인덱스를 wk2 리스트의 인덱스로 추가
			...
			if (region.equals("[근무지역]") && typeOccup.equals(typeOccup2) && periodType.equals(periodType2)) {
			...
			if (region.equals(region2) && typeOccup.equals("[근무형태]") && periodType.equals("[근무기간]")) {
				System.out.println(pt.get(i));
			...
			if (region.equals(region2) && typeOccup.equals(typeOccup2) && periodType.equals("[근무기간]")) {
				System.out.println(pt.get(i));
			...
			if (region.equals("[근무지역]") && typeOccup.equals(typeOccup2) && periodType.equals("[근무기간]")) {
				System.out.println(pt.get(i));
			...
			if (region.equals(region2) && typeOccup.equals("[근무형태]") && periodType.equals(periodType2)) {
				System.out.println(pt.get(i));
